                                             ...
                                             ref Material defaultMaterial)
        {
            ...
            foreach (var meshFilter in settings.MeshFilters)
            {
                ...
                for (int i = 0; i < meshFilter.sharedMesh.subMeshCount; ++i)
                {
                    ...
                    // Local patch: Object.GetInstanceID() is obsolete-as-error from Unity 6.3 onward, so derive the id from EntityId instead.
                    meshIDTable.Add(new MeshCombineResult.MeshID() { Mesh = meshFilter.sharedMesh, MeshFilterID = meshFilter.GetEntityId().GetHashCode(), VertexAttributeID = meshID });
                }
            }
